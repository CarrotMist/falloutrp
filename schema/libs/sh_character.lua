				...
				for k, v in SortedPairs(faction.models) do
					...
					icon.DoClick = function(this)
						...
						if(!preview) then
							...
							preview:SetPos(ScrW() * 0.4, ScrH()/4.5)			
							preview:SetSize(ScrW() * 0.2, ScrH()/3)		
						...
						if(prevEnt) then
							...
							for k2, v in pairs(prevEnt:GetBodyGroups()) do
								...
								tempSlide:SetPos(ScrW() * 0.335, y*1.08 + (k2-1)*35) --this is terrible.
							...
							slider:SetPos(ScrW() * 0.335, y*1.4-70)	
