-- This is WIP and probably needs some work, I have copied the code for DTextEntry from the gmod github repo and editied it to look like fallout so we can still have the normal text entry.
local PANEL = {}
...
vgui.Register("forpTextEntry", PANEL, "DPanel")
