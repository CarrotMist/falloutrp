...
nut.command.add("forums", {
    syntax = "<No Input>",
	onRun = function(client, arguments)
	 client:SendLua([[gui.OpenURL("https://www.ceriseservers.com/forums/index.php")]])
	end
})
...
nut.command.add("discord", {
    syntax = "<No Input>",
	onRun = function(client, arguments)
	 client:SendLua([[gui.OpenURL("https://discord.gg/EDBVBh4")]])
	end
})
...
nut.command.add("steamgroup", {
    syntax = "<No Input>",
	onRun = function(client, arguments)
	 client:SendLua([[gui.OpenURL("https://steamcommunity.com/groups/ceriseservers")]])
	end
})

nut.command.add("donate", {
    syntax = "<No Input>",
	onRun = function(client, arguments)
	 client:SendLua([[gui.OpenURL("https://sdonate.com/stores/ceriseservers/")]])
	end
})
...
nut.command.add("content", {
    syntax = "<No Input>",
	onRun = function(client, arguments)
	client:SendLua([[gui.OpenURL("https://steamcommunity.com/sharedfiles/filedetails/?id=1616262443")]])
	end
})